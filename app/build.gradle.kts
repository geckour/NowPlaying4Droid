...
android {
    ...
    defaultConfig {
        ...
        buildConfigField(
            "String",
            keyNameTwitterConsumerSecret,
            getKey(keyNameTwitterConsumerSecret)
        )
        ...
        buildConfigField(
            "String",
            keyNameMastodonInstancesSecret,
            getKey(keyNameMastodonInstancesSecret)
        )
        ...
        buildConfigField(
            "String",
            keyNameAppleMusicKitSecretKey,
            getKey(keyNameAppleMusicKitSecretKey)
        )
    }
